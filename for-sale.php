...
// Base query for SALE properties
// Assuming 'Sale' or '2' represents Sale in available_for, and status != '7' means active
$where = "WHERE (pl.available_for LIKE '%Sale%' OR pl.available_for LIKE '%Sell%' OR pl.available_for LIKE '%Buy%' OR pl.available_for = '2' OR pl.available_for = 'Sale') AND pl.status != '7'";
...
if (!empty($db_properties)) {
    foreach ($db_properties as $row) {
        ...
        $sale_properties[] = [
            ...
            'price_display' => 'KES. ' . number_format((float)$row->property_price),
...
$items_per_page = 6;
$chunks = array_chunk($sale_properties, $items_per_page);
...
<section class="vc-rent-banner">
    ...
    <div class="vc-banner-content">
        ...
        <div class="vc-banner-badge">
            ...
            <span><strong><?php echo count($sale_properties); ?></strong> Properties Available</span>
        </div>
    </div>
</section>
...
<div class="vc-results-summary mb-4" data-aos="fade-up">
    <div class="d-flex justify-content-between align-items-center">
        <div class="vc-count-text">
            Showing <span class="vc-count-num"><?php echo count($sale_properties); ?></span> Properties
        </div>
...
<div class="text-center py-5" data-aos="fade-up">
    ...
    <h3 class="mt-4">No properties for sale found</h3>
